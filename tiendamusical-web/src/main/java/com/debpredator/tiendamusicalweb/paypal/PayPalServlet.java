...
import com.debpredator.tiendamusicalweb.controllers.CarritoController;
...
public class PayPalServlet extends HttpServlet {
	...
	private static final Logger LOGGER = LogManager.getLogger(PayPalServlet.class);//import org.apache.logging.log4j.Logger;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		LOGGER.info("Generando orden de PayPal 1");
		...
		if (session.getAttribute("sessionBean") != null) {
			...
			LOGGER.info("Generando orden de PayPal 2: " + sessionBean.getTotalCompra());
